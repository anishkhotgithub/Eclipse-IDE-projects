...
<body>
	<jsp:include page="Header.jsp"></jsp:include>
		...
		<form action="UpdateServlet?bookid=${row.bookid}" method="post" class="myclass col-lg-6 col-md-9 col-sm-12 col-xs-12">
			<div class="form-group">
				<label>Enter Book id</label>
				<input type="text" name="bookid" value="${row.bookid}" placeholder="Enter id" class="form-control"/>
			</div>
			<div class="form-group">
